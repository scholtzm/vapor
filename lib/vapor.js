...
Vapor.prototype.essentials = function() {
    // Register essential handlers for logging of all the major Steam events
...
Vapor.prototype.start = function() {
    ...
    this.log.info('Starting %s v%s', appinfo.name, appinfo.version);
    this.log.info('Starting bot: %s (%s)', config.displayName, config.username);
