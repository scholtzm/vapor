...
Utils.prototype.isAdmin = function(steamID) {
  ...
  vapor.emit('message:warn', 'This method is deprecated and will be removed in the next major version.');
  return vapor._config.admins.indexOf(steamID) > -1;
};
...
Utils.prototype.getUserDescription = function(steamID, format) {
  var result = format || '%username (%steamid64)';
