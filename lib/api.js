 ...
 * @param  {Boolean} complete If true, function will return complete Vapor config.
 * Otherwise function will return only plugin-specific config. Defaults to false.
 * @return {Object}           Config object.
 */
API.prototype.getConfig = function(complete) {
...
API.prototype.emitEvent = function() {
    var args = arguments;
    args[0] = _getPluginEventName(this._pluginName, args[0]);
