...
API.prototype.getHandler = function(handler) {
    switch (handler) {
        ...
        case 'steamGameCoordinator':
            return this._vapor._steamGameCoordinator;
        case 'steamGroups':
...
API.prototype.registerHandler = function(options, callback) {
    ...
    switch(options.emitter) {
        ...
        case 'steamGameCoordinator':
            vapor._steamGameCoordinator.on(options.event, callback);
            break;
...
API.prototype.hasHandler = function(options) {
    ...
    switch(options.emitter) {
        ...
        case 'steamGameCoordinator':
            return vapor._steamGameCoordinator.listeners(options.event).length > 0;
        ...
        case GLOBAL_EVENT_EMITTER:
            ...
            total += vapor._steamGameCoordinator.listeners(options.event).length;
...
API.prototype.removeAllHandlers = function(options) {
    ...
    switch(options.emitter) {
        ...
        case 'steamGameCoordinator':
            vapor._steamGameCoordinator.removeAllListeners(options.event);
            break;
