 ...
 * @property {string} dataDir    Path to data directory for this specific plugin and username.
 */
function API(Vapor, pluginName, data) {
    ...
    this.data = data;
    this.dataDir = path.join(_vapor.config.dataDir, Misc.DATA_PLUGIN_DIR, _vapor.config.username, pluginName);
